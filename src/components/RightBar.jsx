...
const RightBar = () => {
  return (
    ...
    <>
        <div className='h-80 w-80 fixed top-0 right-0 border border-white/40  mt-[70px] overflow-y-scroll text-white p-[15px] rounded-xl'>
            ...
            <div className="flex  items-center justify-between  gap-[10px] mt-[5px] mb-[10px]">
                ...
                <div className='h-10 w-25 border border-white/40 rounded-3xl flex justify-center items-center hover:scale-101 hover:bg-white/20 transition duration-200'>Follow</div>
