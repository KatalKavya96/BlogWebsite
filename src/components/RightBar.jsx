...
const RightBar = () => {
  return (
    ...
    <>
        <div className='h-[43vh] w-90 fixed top-2 right-2 border border-white/30  mt-[70px] overflow-y-scroll text-white p-[15px] rounded-lg custom-scroll-hide bg-adder shadow-[-5px_10px_15px_2px_rgba(0,0,0,0.5)]'>
            ...
            <div className="flex  items-center justify-between  gap-[10px] mt-[5px] mb-[10px]">
                ...
                <div className='flex  items-center gap-[5px]'>
                    ...
                    <h1>@YashRaghuvanshi</h1>
                </div>
                <div className='h-10 w-25 border border-white/40 rounded-3xl flex justify-center items-center hover:scale-101 hover:bg-orange-800 transition duration-200 cursor-pointer'>Follow</div>
